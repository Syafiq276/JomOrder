    ...
    return (
        <div className="receipt-view">
            ...
            <div className="receipt-actions no-print">
                <button className="pos-btn pos-btn--gold" onClick={onPrint}>🖨️ Cetak Resit</button>
                <button className="pos-btn pos-btn--success" onClick={() => onShareWhatsApp(order, subtotal)}>📱 Kongsi WhatsApp</button>
